...
const Link1 = (props: PageProps) => {
  ...
  if (props.FacebookTagSection1) adicionarScriptAoHead(props.FacebookTagSection1);
  if (props.GoogleTagSection1) adicionarScriptAoHead(props.GoogleTagSection1);

  useEffect(() => {
    const redirectUrl = props.FirstSectionButtonHref; // URL padrão se ButtonHref for undefined
