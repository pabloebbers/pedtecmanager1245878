...
const Link1 = (props: PageProps) => {
  ...
  if (props.FacebookTagSection3) adicionarScriptAoHead(props.FacebookTagSection3);
  if (props.GoogleTagSection3) adicionarScriptAoHead(props.GoogleTagSection3);

  useEffect(() => {
    const redirectUrl = props.ThirdSectionButtonHref; // URL padrão se ButtonHref for undefined
